...
public class Algoritmi {
	...
	public static String vratiMinHillClimbing(String upit){
...
//		System.out.println("<>");
		...
		nizPocetak[1]=upit;
		double max = tfPojasnjenje.izvrsiZaPoredjenje(nizPocetak);
		...
		while (iterator.hasNext()) {
		    ...
		    double similarity = tfPojasnjenje.izvrsiZaPoredjenje(nizDokumenata);
	...
	public static String pomocMetoda(String text,String upit){
...
//			String sadrzajPrvog = rezultatMetode.split("presek")[1];
			...
			String[] nizPocetak = new String[2];
			nizPocetak[0]= Metode.vratiStringFajla(text).trim();
			nizPocetak[1]=text;
			double max = tfPojasnjenje.izvrsiZaPoredjenje(nizPocetak);
	...
	public static void main(String[] args){
		...
		*/
		vratiMinHillClimbing("Just leave me alone and let me eat right now ok");
