...
public class CosineSimilarity2 {
	...
	public static HashMap vratiNajslicnije(String text){
		...
		HashMap tekstovi = Kontroler2.getInstanca().getTekstovi();
...
//			   
	...
	public static void main(String[] args){
		...
		*/
		...
		System.out.println(Metode.vratiPrviElementIzMape(CosineSimilarity2.vratiNajslicnije("But you just said you are vegan i am out")));
	}
}
